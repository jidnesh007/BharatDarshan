...
const QutubMinar = () => {
  ...
  const carouselImages = [
    ...
    },
    {
      url: "/images/q2.jpg",
      title: "Qutub Minar",
      description: "Indo-Islamic Marvel",
    },
    {
      url: "/images/q3.jpg",
      title: "Qutub Minar",
  ...
  const amazingFacts = [
    {
      ...
      fact: "The Qutub Minar was initiated by Qutb-ud-din Aibak in 1192 and completed by his successor Iltutmish, marking the start of the Delhi Sultanate.",
      color: "text-blue-600",
    },
    {
      icon: Crown,
      title: "Architectural Marvel",
      fact: "Standing at 73 meters, it is the tallest brick minaret in the world, adorned with intricate carvings and verses from the Quran.",
      color: "text-purple-600",
    },
    {
      icon: Sparkles,
      title: "Iron Pillar Mystery",
      fact: "The nearby Iron Pillar, over 1,600 years old, has not rusted despite being exposed to the elements, baffling scientists.",
      color: "text-yellow-600",
    },
    {
      icon: Star,
      title: "Cultural Blend",
      fact: "The minaret showcases a blend of Indo-Islamic architectural styles, with influences from Persian and Indian traditions.",
      color: "text-red-600",
    },
    {
      icon: Award,
      title: "UNESCO Heritage",
      fact: "Declared a UNESCO World Heritage Site in 1993 for its outstanding historical and architectural significance.",
  ...
  const videoContent = {
    historical: [
      {
        id: "5zYOKFjpm9s",
        title: "The Rise of the Delhi Sultanate",
        description:
          "Explore the historical significance of Qutub Minar and the Delhi Sultanate's origins",
        duration: "14:20",
        views: "1.9M",
        rating: 4.8,
      ...
      },
      {
        ...
        description:
          "Discover the engineering feats behind the tallest brick minaret",
        duration: "11:50",
        views: "1.5M",
        rating: 4.7,
      ...
      {
        id: "dQw4w9WgXcQ",
        title: "Qutb-ud-din Aibak's Legacy",
        description:
          "Learn about the founder of the Delhi Sultanate and his vision",
        duration: "16:10",
        views: "2.3M",
        rating: 4.9,
        category: "History",
    ...
    cultural: [
      {
        id: "dQw4w9WgXcQ",
        title: "Life in Medieval Delhi",
        description:
          "Experience the vibrant culture of Delhi during the Sultanate period",
        duration: "13:25",
        views: "1.2M",
        rating: 4.6,
        category: "Culture",
      ...
      {
        id: "dQw4w9WgXcQ",
        title: "Artisans of the Qutub Complex",
        description:
          "Meet the craftsmen who shaped the intricate designs of the minaret",
        duration: "10:40",
        views: "780K",
        rating: 4.5,
      ...
      {
        id: "dQw4w9WgXcQ",
        title: "Festivals at Qutub Minar",
        description:
          "Celebrate the cultural festivals hosted at the Qutub complex",
        duration: "12:55",
        views: "1.0M",
        rating: 4.7,
        category: "Festivals",
    ...
    music: [
      {
        id: "dQw4w9WgXcQ",
        title: "Qawwali at Qutub",
        description:
          "Soulful Qawwali performances echoing the spiritual heritage of the site",
        duration: "22:30",
        views: "2.5M",
        rating: 4.9,
        category: "Qawwali Music",
      },
      {
        id: "dQw4w9WgXcQ",
        title: "Classical Music of Delhi",
        description:
          "Traditional ragas inspired by the medieval courts of Delhi",
        duration: "30:15",
        views: "1.7M",
        rating: 4.8,
        category: "Classical",
      ...
      {
        id: "dQw4w9WgXcQ",
        title: "Folk Songs of North India",
        description:
          "Melodies celebrating the history and beauty of Qutub Minar",
        duration: "18:50",
        views: "1.3M",
        rating: 4.7,
        category: "Folk Music",
    ...
    mythology: [
      {
        id: "dQw4w9WgXcQ",
        title: "Myths of the Qutub Complex",
        description:
          "Unravel the mysteries and legends surrounding the ancient site",
        duration: "15:40",
        views: "2.2M",
        rating: 4.8,
        category: "Mystery",
      ...
      {
        id: "dQw4w9WgXcQ",
        title: "Explore the legend of the rust-resistant Iron Pillar",
        description: "The Iron Pillar Enigma",
        duration: "11:20",
        views: "1.6M",
        rating: 4.6,
        category: "Legends",
      },
      {
        ...
        description:
          "The minaret's role in Islamic and Indian spiritual traditions",
        duration: "19:30",
        views: "1.8M",
        rating: "4.9",
    ...
    virtual: [
      {
        id: "dQw4w9WgXcQ",
        title: "360° Tour of Qutub Minar",
        description: "Immersive virtual reality tour of the Qutub complex",
        duration: "26:20",
        views: "3.8M",
        rating: "4.9",
      ...
      {
        id: "dQw4w9WgXcQ",
        title: "Drone View of Qutub Minar",
        description: "Stunning aerial perspectives of the towering minaret",
        duration: "7:50",
        views: "2.9M",
        rating: "4.8",
      ...
      {
        id: "dQw4w9WgXcQ",
        title: "Time-lapse: Qutub Minar",
        description:
          "Witness the minaret's beauty through a day-to-night transition",
        duration: "4:10",
        views: "4.8M",
        rating: "4.9",
        category: "Time-lapse",
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="prose prose-sm sm:prose-base md:prose-lg text-gray-700 space-y-4 sm:space-y-6 mb-6 sm:mb-8">
                <p className="text-base sm:text-lg md:text-xl leading-relaxed">
                  Rising majestically in Mehrauli, Delhi, the Qutub Minar is a
                  towering testament to the architectural prowess of the Delhi
                  Sultanate. Initiated by Qutb-ud-din Aibak in 1192, this
                  73-meter minaret is the tallest brick minaret in the world and
                  a UNESCO World Heritage Site.
                </p>
                <p className="text-sm sm:text-base md:text-lg leading-relaxed text-gray-600">
                  The minaret's intricate carvings, Quranic verses, and blend of
                  Indo-Islamic styles make it a masterpiece. The nearby Iron
                  Pillar, a metallurgical marvel, adds to the site's historical
                  intrigue, standing rust-free for over 1,600 years.
                </p>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-6 sm:mb-8">
                ...
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-3 sm:p-4 border border-green-100 hover:shadow-md transition-all duration-300">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600">Since 1993</p>
                </div>
              </div>
              ...
              <div className="mb-6 sm:mb-8">
                ...
                <div className="relative">
                  ...
                  {[
                    {
                      year: "1192",
                      event: "Qutb-ud-din Aibak begins construction",
                      color: "red",
                    },
                    {
                      year: "1220",
                      event: "Iltutmish completes first three storeys",
                      color: "blue",
                    },
                    {
                      year: "1368",
                      event: "Firoz Shah Tughlaq restores the minaret",
                      color: "green",
                    },
                    {
                      year: "1505",
                      event: "Sikandar Lodi adds topmost storey",
                      color: "purple",
                    },
                    {
                      year: "1993",
                    ...
                    {
                      year: "2006",
                      event: "Night tourism introduced",
                      color: "pink",
                    },
                  ].map((item, index) => (
                    <div
              ...
              <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-lg p-3 sm:p-4 border border-orange-100">
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative rounded-lg overflow-hidden border border-orange-200 shadow-sm">
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3506.197138105757!2d77.18315231456867!3d28.524475982462697!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d1e9c8c8f7c1f%3A0x9c5c3f3b86e6f7e8e!2sQutub%20Minar!5e0!3m2!1sen!2sin!4v1625123456789!5m2!1sen!2sin"
                      width="100%"
                      height="120"
                      style={{ border: 0 }}
                      allowFullScreen=""
                  ...
                  <div className="grid grid-cols-2 gap-2 sm:gap-3 text-xs sm:text-sm">
                    <div className="bg-white/50 rounded-lg p-2 sm:p-3">
                      ...
                      <p className="font-semibold text-orange-600">
                        Connaught Place: 14km
                      </p>
                    </div>
                    <div className="bg-white/50 rounded-lg p-2 sm:p-3">
                      <p className="text-gray-600">Delhi Airport</p>
                      <p className="font-semibold text-orange-600">15km away</p>
                    </div>
                  </div>
                  <div className="bg-gradient-to-r from-blue-100 to-cyan-100 rounded-lg p-2 sm:p-3 border border-blue-200">
                    ...
                    <p className="text-xs text-blue-600 mt-1">
                      Take the Delhi Metro Yellow Line to Qutub Minar station
                      (15 min walk)
                    </p>
                  </div>
                </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-gradient-to-r from-orange-100 to-yellow-100 rounded-lg p-2 sm:p-3 border border-orange-200">
                      ...
                      <p className="text-xs text-orange-600">
                        Golden hour: 6:30-7:30 AM & 5:30-6:30 PM
                      </p>
                    </div>
                  </div>
                ) : (
