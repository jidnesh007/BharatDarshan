                ...
                <div style="min-width: 280px; max-width: 320px; font-family: system-ui, -apple-system, sans-serif;">
                  <div style="position: relative; height: 120px; background: url('${
                    ...
                    <div style="position: absolute; top: 8px; left: 8px; background: ${
                      ...
                      <img src="${category.symbol}" style="width: 12px; height: 12px;" /> ${site.type}
                    </div>
                  </div>
      ...
      <div className={`bg-white rounded-2xl shadow-lg p-6 ${className}`}>
        <div className="text-center">
          <div className="w-16 h-16 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-4">
            <img src="https://cdn-icons-png.flaticon.com/512/1160/1160119.png" className="w-8 h-8" />
          </div>
        ...
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-bold text-gray-800 flex items-center">
              <img src="https://cdn-icons-png.flaticon.com/512/1946/1946392.png" className="w-6 h-6 mr-2" />
              Heritage Sites Map
            </h2>
      ...
      <div className="relative">
        ...
        <div className="absolute bottom-4 left-4 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-gray-200">
          <h4 className="text-sm font-bold text-gray-800 mb-3 flex items-center">
            <img src="https://cdn-icons-png.flaticon.com/512/684/684908.png" className="w-4 h-4 mr-2" />
            Symbol Legend
          </h4>
          ...
          <div className="flex items-start justify-between mb-4">
            <div className="flex-1">
              ...
              <div className="flex items-center space-x-4 text-sm text-gray-600 mb-2">
                <span className="flex items-center">
                  <img src="https://cdn-icons-png.flaticon.com/512/3597/3597071.png" className="w-4 h-4 mr-1" />
                  {selectedSite.period}
                </span>
                <span className="flex items-center">
                  <img src="https://cdn-icons-png.flaticon.com/512/1828/1828970.png" className="w-4 h-4 mr-1" />
                  {selectedSite.rating || 4.5}
                </span>
                <span className="flex items-center">
                  <img src="https://cdn-icons-png.flaticon.com/512/3039/3039420.png" className="w-4 h-4 mr-1" />
            ...
            <div className="flex items-center space-x-2 ml-4">
              ...
              <button
                ...
                title="Share site"
              >
                <img src="https://cdn-icons-png.flaticon.com/512/1828/1828959.png" className="w-5 h-5" />
              </button>
            </div>
          </div>
          ...
          {selectedSite.bestTime && (
            <div className="mt-4 p-3 bg-green-50 rounded-lg">
              <div className="flex items-center">
                <img src="https://cdn-icons-png.flaticon.com/512/1888/1888423.png" className="w-4 h-4 mr-2" />
