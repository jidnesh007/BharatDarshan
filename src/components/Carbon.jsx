            ...
            <div className="absolute inset-0 flex items-center justify-center p-6 pointer-events-none">
                <div className="text-center max-w-5xl">
                    ...
                    <p className="text-xl md:text-2xl lg:text-3xl text-white leading-relaxed font-light tracking-wide max-w-4xl mx-auto">
                        <span className="font-medium text-amber-100">Harness AI</span> to estimate the carbon footprint of tourism at heritage sites.
                        <br className="hidden md:block" />
                        <span className="text-gray-200">Discover eco-friendly practices, calculate environmental impact, and embrace sustainable carbon credits.</span>
                    </p>
